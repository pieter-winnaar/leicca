/**
 * mintBlue V2 Theme Definition
 *
 * Updated mintBlue brand theme with new color palette.
 * Uses same logo assets as original mintblue theme.
 *
 * This file contains the complete mintBlue V2 theme configuration
...
/**
 * Light mode color palette for mintBlue V2 theme
 *
 * All colors are in oklch format for perceptual uniformity.
 */
export const mintblueV2LightColors: ColorPalette = {
  // Primary brand colors
  primary: 'oklch(0.2345 0.1142 317.0843)',       // Deep purple
  ...
  accent: 'oklch(0.9700 0 0)',                    // Light gray
  accentForeground: 'oklch(0.4520 0.3132 264.0520)',

  // Surface colors (light mode)
  background: 'oklch(0.9846 0.0017 247.8389)',    // Very light gray
  foreground: 'oklch(0.2345 0.1142 317.0843)',    // Deep purple
  surface: 'oklch(0.9670 0.0029 264.5419)',       // Light gray (popover)
  onSurface: 'oklch(0.2345 0.1142 317.0843)',     // Deep purple
...
/**
 * Dark mode color palette for mintBlue V2 theme
 */
export const mintblueV2DarkColors: ColorPalette = {
  // Primary colors - Light cyan/turquoise in dark mode
  primary: 'oklch(0.9582 0.0595 184.5549)',
 ...
 */
export const mintblueV2LightSidebarColors: SidebarColors = {
  ...
  sidebarAccentForeground: 'oklch(0.4520 0.3132 264.0520)',
 ...
 */
export const mintblueV2DarkSidebarColors: SidebarColors = {
 ...
 */
export const mintblueV2LightChartColors: ChartColors = {
 ...
 */
export const mintblueV2DarkChartColors: ChartColors = {
 ...
 */
export const mintblueV2Shadows: Shadows = {
...
/**
 * Complete mintBlue V2 theme (light mode)
 *
 * Uses same logo assets as original mintblue theme.
 */
export const mintblueV2Theme: Theme = {
  name: 'mintblue-v2',
  colors: mintblueV2LightColors,
  sidebarColors: mintblueV2LightSidebarColors,
  chartColors: mintblueV2LightChartColors,
  typography: {
    fontFamilies: {
  ...
  borderRadius: {
    none: '0',
    sm: 'calc(0.4rem - 4px)',      // Based on --radius: 0.4rem
    md: 'calc(0.4rem - 2px)',
    lg: '0.4rem',                  // --radius
    xl: 'calc(0.4rem + 4px)',
    '2xl': '1rem',
...
/**
 * mintBlue V2 theme dark mode variant
 */
export const mintblueV2ThemeDark: Theme = {
  ...mintblueV2Theme,
  colors: mintblueV2DarkColors,
  sidebarColors: mintblueV2DarkSidebarColors,
  chartColors: mintblueV2DarkChartColors,
};
 ...
 * Light mode:
 * ```typescript
 * import { mintblueV2Theme } from '@/themes/mintblue-v2.theme';
 * const theme = mintblueV2Theme;
 * ```
 *
 * Dark mode:
 * ```typescript
 * import { mintblueV2ThemeDark } from '@/themes/mintblue-v2.theme';
 * const theme = mintblueV2ThemeDark;
 * ```
 *
 * Or use ThemeService to get variants dynamically:
 * ```typescript
 * const themeService = new ThemeService();
 * const lightTheme = themeService.getThemeVariant('mintblue-v2', 'light');
 * const darkTheme = themeService.getThemeVariant('mintblue-v2', 'dark');
 * ```
 */
